...
public class Result<T> {
    ...
    public enum ErrorCode {
        ...
        INCREASE_GOODS_FAILED(404, "INCREASE_GOODS_FAILED"),
        CHANGE_SALE_GOODS_FAILED(405, "CHANGE_SALE_GOODS_FAILED"),

        CREATE_MEMBER_FAILED(500, "CREATE_MEMBER_FAILED"),
        UPDATE_MEMBER_FAILED(501, "UPDATE_MEMBER_FAILED"),
        DELETE_MEMBER_FAILED(502, "DELETE_MEMBER_FAILED"),
        QUERY_MEMBER_FAILED(503, "QUERY_MEMBER_FAILED"),

        UPLOAD_IMAGE_FAILED(900, "UPLOAD_IMAGE_FAILED"),
        UPLOAD_IMAGE_EMPTY(901, "UPLOAD_IMAGE_EMPTY");
